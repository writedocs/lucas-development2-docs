...
The credentials used for the [Your-Company] API differ between the Sandbox and Production environments. Depending on the environment you select within the Dashboard, you will receive different API keys and account information.a
</Callout>
