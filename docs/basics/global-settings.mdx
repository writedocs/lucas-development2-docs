...
---
a
Every WriteDocs documentation site requires a **`config.json`** file to handle the oi essential configuration settings. Explore the available attributes below to get started.
